return {
  ...
  keys = {
    ...
    { "<leader>xw", "<cmd>TroubleToggle lsp_workspace_diagnostics<cr>", desc = "Toggle Trouble Workspace Diagnostics" },
    { "<leader>xd", "<cmd>TroubleToggle lsp_document_diagnostics<cr>", desc = "Toggle Trouble Document Diagnostics" },
